    ...
    <section className="relative pt-32 pb-24 px-6 overflow-hidden bg-white mt-16">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-10">
          <div>
            {/* 브레드크럼 - nav 태그와 시맨틱 정보 보강 */}
            <nav
              className="flex items-center gap-1.5 text-xs font-bold mb-8"
              aria-label="Breadcrumb"
            >
              <Link
                href="/"
                className="px-2.5 py-1 rounded-full bg-white border border-gray-100 text-gray-500 shadow-sm hover:text-blue-600 transition-colors"
              >
                Home
              </Link>
          ...
          <div className="relative md:pb-2">
            <div
              className="absolute -left-5 top-0 bottom-0 w-1 bg-blue-500 rounded-full hidden md:block"
              aria-hidden="true"
            ></div>
