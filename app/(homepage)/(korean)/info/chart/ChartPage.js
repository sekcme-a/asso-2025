  ...
  return (
    <>
      ...
      <section
        ...
        aria-labelledby="chart-main-title"
      >
        <div
        ...
        />
        <div
          className="absolute inset-0 [background-image:linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] [background-size:60px_60px] pointer-events-none"
          aria-hidden="true"
        />
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="space-y-12">
            {CHART.map((floor, floorIndex) => (
              <div key={floorIndex} className="org-floor">
                {floor.all ? (
...
function OrgCard({
  ...
  const sectionTitle = isEnglish ? section.positionEn : section.position;
