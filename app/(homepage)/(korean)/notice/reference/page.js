...
export const metadata = createMetadata({
  title: "자료실",
  description: "대한생활체육회의 모든 자료를 확인해보세요.",
  url: "/notice/reference",
});
        ...
        subTitle={
          <>
            {t(
              ...
              "Access and download various regulations, forms, and key activity materials of the Korea Sports Council for All.",
            )}
            <br />
          </>
        }
