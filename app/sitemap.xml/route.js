...
export async function GET() {
  ...
  const today = "2026-04-07T00:00:00Z";
  ...
  const staticURLs = [
    ...
    {
      loc: `${baseUrl}/notice/anouncement`,
      lastmod: today,
      changefreq: "daily",
      priority: "0.8",
    },
    {
      loc: `${baseUrl}/notice/media`,
      lastmod: today,
      changefreq: "daily",
      priority: "0.8",
    },
    {
      loc: `${baseUrl}/notice/photo`,
      lastmod: today,
      changefreq: "weekly",
      priority: "0.7",
    },
    {
      loc: `${baseUrl}/notice/video`,
      lastmod: today,
      changefreq: "weekly",
      priority: "0.7",
    },
    {
      loc: `${baseUrl}/notice/apply`,
      lastmod: today,
      changefreq: "monthly",
      priority: "0.6",
    },
    {
      loc: `${baseUrl}/notice/schedule`,
      lastmod: today,
      changefreq: "weekly",
      priority: "0.7",
    },
    {
      loc: `${baseUrl}/notice/reference`,
      lastmod: today,
      changefreq: "monthly",
      priority: "0.6",
    },
    {
      loc: `${baseUrl}/notice/sup`,
      lastmod: today,
      changefreq: "monthly",
      priority: "0.6",
    },
