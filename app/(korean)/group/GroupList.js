...
const GroupList = ({ type, groups }) => {
  ...
  return (
    <main>
      ...
      />
      <div className="relative py-12 px-6 bg-[#fcfcfd] min-h-screen overflow-hidden">
        {/* 배경 패턴 */}
        <div className="absolute inset-0 [background-image:linear-gradient(#e5e7eb_1px,transparent_1px),linear-gradient(to_right,#e5e7eb_1px,transparent_1px)] [background-size:40px_40px] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] opacity-20 pointer-events-none" />
        <div className="absolute top-0 right-0 w-1/3 h-full bg-blue-600/5 -skew-x-12 transform translate-x-20 pointer-events-none z-0" />
        ...
        <div className="max-w-4xl mx-auto relative z-10">
              ...
              >
                <div className="flex flex-col md:flex-row items-stretch">
                  ...
                  <div className="flex-1 p-5 md:p-6">
                    <h2 className="text-xl font-black text-gray-900 tracking-tight mb-4 group-hover:text-blue-600 transition-colors">
                      {isEnglish
                    ...
                    <div className="relative pl-4 border-l-2 border-gray-100 group-hover:border-blue-100 transition-colors">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-base font-bold text-gray-900">
                          {isEnglish ? group.nameEn || group.name : group.name}{" "}
          ...
          {/* FOOTER */}
          <div className="mt-16 py-8 text-center border-t border-gray-100">
