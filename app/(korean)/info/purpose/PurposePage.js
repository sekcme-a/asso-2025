...
export default function PurposePage() {
  ...
  return (
    <main>
      ...
      />
      <section className="relative py-32 px-6 overflow-hidden bg-[#f4f4f6]">
        {/* --- BACKGROUND DESIGN (수정 없음) --- */}
        <div className="absolute inset-0 opacity-[0.15] [background-image:radial-gradient(#4f46e5_1px,transparent_1px)] [background-size:40px_40px] pointer-events-none" />
        <div className="absolute top-[-10%] left-[-5%] w-[800px] h-[800px] bg-blue-100/30 rounded-full blur-[160px] pointer-events-none" />
        <div className="absolute bottom-[-5%] right-[-5%] w-[600px] h-[600px] bg-white rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="mb-24 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
            ...
            <div className="h-[1px] flex-1 bg-gray-200 mx-10 hidden lg:block mb-4 opacity-50" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            {/* 마지막 가이드 카드 */}
            <div className="p-8 bg-blue-600 rounded-[2rem] flex flex-col justify-between overflow-hidden relative shadow-xl shadow-blue-200">
              ...
              <div className="absolute top-0 right-0 w-32 h-32 bg-white blur-[60px] opacity-20" />
            </div>
          </div>
        </div>
      </section>
